...
if(isset($_SESSION["huoma.admin"])){
	...
	if(empty($qudao_title)){
		...
		// 更新数据库
		mysqli_query($conn,"UPDATE qun_huoma_qudao SET qudao_title='$qudao_title',qudao_yuming='$qudao_yuming',qudao_type='$qudao_type',qudao_content='$qudao_content',qudao_biaoqian='$qudao_biaoqian',qudao_update_time='$date' WHERE qudao_id=".$qudao_id);
		$result = array(
			"result" => "100",
			"msg" => "更新成功"
		);
