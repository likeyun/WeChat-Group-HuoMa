...
if(isset($_SESSION["username"])){
  ...
  if((int)$num+1 > (int)$max2)
  {
	...
	if(empty($qudao_title)){
		...
		$date = date("Y-m-d");
		// 插入数据库
		$sql = "INSERT INTO qun_huoma_qudao (qudao_title,qudao_type,qudao_biaoqian,qudao_content,qudao_yuming,qudao_id,qudao_pageview,qudao_update_time,user) VALUES ('$qudao_title', '$qudao_type', '$qudao_biaoqian', '$qudao_content', '$qudao_yuming', '$qudao_id', '0', '$date','$username')";
